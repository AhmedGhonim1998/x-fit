...
export default function AbdulrahmanPlan() {
    return (
        <>
            ...
            <CoachesOffers offer1="3 month"  offer2="6 month" offer3="12 month" saving1="save 12%" saving2="save 16%" saving3="save 24%"  partnerSav1="save 23%" partnerSav2="save 26%" Friends="save 17%" priceOffer="Starting from 4500 EGP" saving4="save 23%"/>
        </>
    )
}
