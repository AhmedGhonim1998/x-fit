...
export default function DamyanPlan() {
    return (
        <>
            ...
            <CoachesOffers  offer1="3 month"  offer2="6 month" offer3="12 month" saving1="save 15%" saving2="save 20%" saving3="save 24%"  partnerSav1="save 32%" partnerSav2="save 20%" Friends="save 17%" priceOffer='6000 EGP/Month'saving4='save 25%'/>
        </>
    )
}
