...
export default function HossamPlan() {
    return (
        <>
            ...
            <CoachesOffers  offer1="3 month"  offer2="6 month" offer3="12 month" saving1="save 10%" saving2="save 15%" saving3="save 24%"  partnerSav1="save 32%" partnerSav2="save 20%" Friends="save 17%" priceOffer='Starting from 3900 EGP'saving4="save 20%" />
        </>
    )
}
